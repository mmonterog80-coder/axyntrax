...
ApplicationWindow {
    ...
    property real currentCpu: 0.0
    property real currentRam: 0.0
    property string currentTime: "--:--:--"

    // Partículas de fondo (comentado por si falla la imagen)
    /*
    ParticleSystem {
        id: particleSys
        anchors.fill: parent
    ...
    */
    ...
    Rectangle {
        ...
        Column {
            ...
            anchors.margins: 10
            spacing: 8
            Text { text: "CPU: " + currentCpu.toFixed(1) + "%"; color: "#e0e0ff"; font.pixelSize: 16 }
            Text { text: "RAM: " + currentRam.toFixed(1) + "%"; color: "#e0e0ff"; font.pixelSize: 16 }
            Text { text: currentTime; color: "#e0e0ff"; font.pixelSize: 16 }
        }
    }
    ...
    Connections {
        ...
        function onCpuChanged(val) {
            currentCpu = val
        }
        function onRamChanged(val) {
            currentRam = val
        }
