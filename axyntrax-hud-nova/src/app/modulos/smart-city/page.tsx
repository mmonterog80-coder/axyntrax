...
export default function smartCityModule() {
  const [active, setActive] = useState(false);
  const Icon = (Icons as any)['Building2'] || Icons.Box;
    ...
    <div className="max-w-5xl mx-auto h-full flex flex-col">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-2">{ 'Optimización de tráfico y consumo energético municipal.' }</p>
        </div>
        <button 
            ...
            <div className="font-mono text-xs text-green-400/80 space-y-2 h-32 overflow-y-auto">
              ...
              {active && (
                <>
                  ...
                  <p className="text-cyan-400">{'>'} Módulo Smart City Grid ONLINE.</p>
                </>
              )}
            </div>
          </motion.div>
