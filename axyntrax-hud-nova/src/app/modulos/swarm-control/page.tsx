...
export default function swarmControlModule() {
  const [active, setActive] = useState(false);
  const Icon = (Icons as any)['Network'] || Icons.Box;
    ...
    <div className="max-w-5xl mx-auto h-full flex flex-col">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <div>
          ...
          <p className="text-gray-400 mt-2">{ 'Monitoreo absoluto de todos los agentes IA de la corporación.' }</p>
        </div>
        <button 
            ...
            <div className="font-mono text-xs text-green-400/80 space-y-2 h-32 overflow-y-auto">
              ...
              {active && (
                <>
                  ...
                  <p className="text-cyan-400">{'>'} Módulo Swarm Control Dashboard ONLINE.</p>
                </>
              )}
            </div>
          </motion.div>
